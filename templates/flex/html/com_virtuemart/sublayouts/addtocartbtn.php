...
if($viewData['orderable']) {
	...
	echo '<input type="submit" name="addtocart" class="add-to-cart addtocart-button" value="'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'" title="'.vmText::_( 'COM_VIRTUEMART_CART_ADD_TO' ).'" />
