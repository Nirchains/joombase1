									...
									<?php if($show_view_button!=0) { ?> 
                                         <?php if( $item->video ) { ?>
											 <?php if($show_zoom_button!=0) { ?>
                                                <a class="btn-zoom gallery-<?php echo $module->id; ?>" href="#" data-featherlight="#sp-simpleportfolio-video<?php echo $item->spsimpleportfolio_item_id; ?>"><?php echo JText::_('MOD_SPSIMPLEPORTFOLIO_WATCH'); ?></a>
                                        ...
                                        <?php } else { ?>
                                          <?php if($show_zoom_button!=0) { ?>
                                            <a class="btn-zoom gallery-<?php echo $module->id; ?>" href="<?php echo $item->popup_img_url; ?>" data-featherlight="image"><?php echo JText::_('MOD_SPSIMPLEPORTFOLIO_ZOOM'); ?></a>
                                            <a class="btn-view" href="<?php echo $item->url; ?>"><?php echo JText::_('MOD_SPSIMPLEPORTFOLIO_VIEW'); ?></a>  
                                           <?php } else { ?>
                                        	<a class="btn-view-only" href="<?php echo $item->url; ?>"><i class="fas fa-link"></i></a> 
                                        <?php } ?> 
...
<script type="text/javascript">jQuery(document).ready(function(){jQuery('.sp-simpleportfolio-btns .gallery-<?php echo $module->id; ?>').featherlightGallery({previousIcon: '<i class="arrow-previous-thin"></i>',nextIcon: '<i class="arrow-next-thin"></i>'});});</script>
